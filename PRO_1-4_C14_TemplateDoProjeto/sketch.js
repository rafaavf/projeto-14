...
function blueBalloon() {
  ...
  blue = createSprite (0,Math.round(random(20, 370)), 10, 1);
...
function greenBalloon() {
  green = createSprite (0,Math.round(random(20, 370)), 10, 1);
  //adicioneImagem para o balão
...
function pinkBalloon() {
  pink = createSprite (0,Math.round(random(20, 370)), 10, 1);
  //adicioneImagem para o balão
